...
resource "aws_ssm_parameter" "KUMO_COMPANY_ID" {
  name  = "${local.parameterstore_path}/KUMO_COMPANY_ID"
  type  = "SecureString"
  value = "PLACEHOLDER" # セキュアストリングの値はコンソールに設定するため仮の値を設定
  lifecycle {
    ignore_changes = [value]
...
resource "aws_ssm_parameter" "KUMO_ORDER_SYSTEM_ENDPOINT" {
  name  = "${local.parameterstore_path}/KUMO_ORDER_SYSTEM_ENDPOINT"
  type  = "SecureString"
  value = "PLACEHOLDER" # セキュアストリングの値はコンソールに設定するため仮の値を設定
  lifecycle {
    ignore_changes = [value]
...
resource "aws_ssm_parameter" "KUMO_ORDER_SYSTEM_USERNAME" {
  name  = "${local.parameterstore_path}/KUMO_ORDER_SYSTEM_USERNAME"
  type  = "SecureString"
  value = "PLACEHOLDER" # セキュアストリングの値はコンソールに設定するため仮の値を設定
  lifecycle {
    ignore_changes = [value]
...
resource "aws_ssm_parameter" "KUMO_SYSTEM_ENDPOINT" {
  name  = "${local.parameterstore_path}/KUMO_SYSTEM_ENDPOINT"
  type  = "SecureString"
  value = "PLACEHOLDER" # セキュアストリングの値はコンソールに設定するため仮の値を設定
  lifecycle {
    ignore_changes = [value]
...
resource "aws_ssm_parameter" "KUMO_TENANT_ID" {
  name  = "${local.parameterstore_path}/KUMO_TENANT_ID"
  type  = "SecureString"
  value = "PLACEHOLDER" # セキュアストリングの値はコンソールに設定するため仮の値を設定
  lifecycle {
    ignore_changes = [value]
...
resource "aws_ssm_parameter" "TODEN_PRICE_PLAN_ID" {
  name  = "${local.parameterstore_path}/TODEN_PRICE_PLAN_ID"
  type  = "SecureString"
  value = "PLACEHOLDER" # セキュアストリングの値はコンソールに設定するため仮の値を設定
  lifecycle {
    ignore_changes = [value]
...
resource "aws_ssm_parameter" "CHUDEN_PRICE_PLAN_ID" {
  name  = "${local.parameterstore_path}/CHUDEN_PRICE_PLAN_ID"
  type  = "SecureString"
  value = "PLACEHOLDER" # セキュアストリングの値はコンソールに設定するため仮の値を設定
  lifecycle {
    ignore_changes = [value]
...
resource "aws_ssm_parameter" "KANSAI_PRICE_PLAN_ID" {
  name  = "${local.parameterstore_path}/KANSAI_PRICE_PLAN_ID"
  type  = "SecureString"
  value = "PLACEHOLDER" # セキュアストリングの値はコンソールに設定するため仮の値を設定
  lifecycle {
    ignore_changes = [value]
...
resource "aws_ssm_parameter" "SAIBU_PRICE_PLAN_ID" {
  name  = "${local.parameterstore_path}/SAIBU_PRICE_PLAN_ID"
  type  = "SecureString"
  value = "PLACEHOLDER" # セキュアストリングの値はコンソールに設定するため仮の値を設定
  lifecycle {
    ignore_changes = [value]
